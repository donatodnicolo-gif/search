...
// ── IL PALLINO GIALLO SULLA VOCE «ATTIVITÀ»: «qui è arrivato qualcosa» ──
//
...
// due: il numero è **quanto lavoro c'è**, il pallino è **è arrivato qualcosa da
// quando hai guardato**. Con un segnale solo, uno dei due casi sparisce.
//
...
const CHIAVE_VISTO = "tasks-sezioni-viste";
...
/** La voce «Attività» della topbar, con numero e pallino; e la fascia di sessione scaduta. */
export function PalliniNav() {
  ...
  return (
    <>
      <Link
        className="topbar-link con-pallini"
        href="/"
      ...
      >
        ...
        {c?.quanti ? (
          <span
            ...
            title={
              c.urgente
                ? `${c.quanti} da fare, e qualcuna scade entro tre giorni`
                : `${c.quanti} da fare`
            }
          >
            {c.quanti}
