...
> 🔴 **11/09/2026 sera (3) — IN LOCALE, non pushato né deployato.** **NUOVO ORDINE: «PAGA ALLA CONSEGNA»** (utente: «metti come possibilità di scelta del pagamento … esempio pagamento alla consegna»). Terza scelta accanto a «link» e «ha già pagato»: l'ordine nasce **subito e da incassare**.
...
> 🔴 **11/09/2026 sera (2) — IN LOCALE, non pushato né deployato.** Tre segnalazioni dell'utente:
