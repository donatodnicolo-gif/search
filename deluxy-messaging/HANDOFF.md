...
> Verificato in locale su :3140 con l'ordine **#12901** (2 righe, partner Enrico Rizzi): il blocco compare, la spunta scrive «Il reclamo è su 1 prodotto di 2», la tendina partner mostra «Enrico Rizzi · MILANO», `npx tsc --noEmit` pulito, e giro completo scrittura/rilettura/cancellazione sulla colonna `prodotti`. **In locale, non ancora pubblicato.**
