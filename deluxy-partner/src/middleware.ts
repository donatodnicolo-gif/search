...
export const config = {
  ...
  matcher: [
    "/((?!login|api/sso|api/fic/callback|api/shopify|api/verifiche|api/fatture|api/proforma|api/tipologie|api/incassi|api/tasks|api/riepilogo-finanziario|api/clienti|api/richieste-pagamento|api/spese|api/cron|_next/static|_next/image|favicon.ico).*)",
  ],
};
