...
export const config = {
  ...
  matcher: [
    "/((?!login|api/fic/callback|api/verifiche|api/fatture|api/proforma|api/tipologie|api/incassi|api/tasks|api/spese|api/cron|_next/static|_next/image|favicon.ico).*)",
  ],
};
