...
// Libro UX&UI v1.4 §7 (sistema del Customer Service): il poller dei pallini (Sidebar)
...
/** Il nome dell'evento: lo manda il poller dei pallini (Sidebar) quando se ne accorge. */
