...
export function PartnerForm({
  ...
  return (
    <form action={action} className="card">
      ...
      <section className="form-section">
        <h3 className="form-section-title">Contatti e bonifici</h3>
        <div className="form-grid">
          <div>
      ...
      <section className="form-section">
        <h3 className="form-section-title">
          Fatturazione e saldi
          <span className="sub">Condizioni economiche e posizioni aperte a inizio anno.</span>
        </h3>
        <div className="form-grid">
          <div>
      ...
      <section className="form-section">
        <h3 className="form-section-title">Stato e note</h3>
        <div className="form-grid">
          <div className="checkbox-row">
