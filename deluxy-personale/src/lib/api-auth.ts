...
// "Authorization: Bearer …"), come in Anagrafiche/Orders/Calendario. Nel
// database c'è solo lo SHA-256 della chiave. Le chiavi si creano dalla pagina
// /chiavi o con `npm run chiave -- <nome-app>`.
//
// L'auth vive SOLO qui: una rotta che si riscrive il controllo scavalca scope
// e revoche (è il buco già trovato e chiuso in Budgets).
...
export function estraiChiave(req: NextRequest): string | null {
