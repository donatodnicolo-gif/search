...
| **Anagrafica completa** | Tutti i prodotti con tutto quello che l'app ne sa: codice, SKU, fornitore e categoria dal negozio, categoria interna, prezzo, costo, collezioni Shopify e venduto. Filtri per fornitore e «cosa manca», ed export CSV per compilare i buchi in foglio di calcolo. | `/anagrafica` |
