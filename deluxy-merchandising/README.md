...
| **Griglie** | Due lenti incrociate (categoria × fascia, fornitore × fascia…): ogni casella dice quanti SKU ci stanno e quanto vendono, con le quote e lo scarto in punti. Verde = rende più di quanto occupa, ambra = il contrario. | `/griglie` |
