...
import { canonizzaLinee, type CategoryRule, type Place, type Priorita } from '@/types';
...
export const REGOLE_FALLBACK: Omit<CategoryRule, 'id'>[] = [
  ...
  { categoria: 'studio legale', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Gifting stagionale e chiusura deal', priorita: 'P2' },
  { categoria: 'consulenza', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Gifting stagionale e chiusura deal', priorita: 'P2' },
  { categoria: 'banca', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Gifting stagionale e chiusura deal', priorita: 'P2' },
  { categoria: 'profumeria', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Regali aziendali + consegne PR/redazionali', priorita: 'P2' },
  { categoria: 'cosmetica', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Regali aziendali + consegne PR/redazionali', priorita: 'P2' },
  { categoria: 'immobiliare di pregio', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Gift closing e welcome home', priorita: 'P2' },
  { categoria: 'wedding', linea_ipotizzata: 'Eventi & Catering', aggancio_apertura: 'Catering + Consegne per allestimenti', priorita: 'P2' },
  { categoria: 'event planner', linea_ipotizzata: 'Eventi & Catering', aggancio_apertura: 'Catering + Consegne per allestimenti', priorita: 'P2' },
  { categoria: 'azienda corporate', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Macarons B2B, kit ricorrenze', priorita: 'P2' },
  { categoria: 'uffici', linea_ipotizzata: 'Gifting', aggancio_apertura: 'Macarons B2B, kit ricorrenze', priorita: 'P2' },
