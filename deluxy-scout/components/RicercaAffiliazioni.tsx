...
const styles = StyleSheet.create({
  ...
  chips: { paddingHorizontal: spacing.lg, gap: 6, alignItems: 'center' },
  ...
  zona: { color: colors.testoSoft, fontSize: 12.5, paddingHorizontal: spacing.lg },
  centro: { alignItems: 'center', gap: 8, padding: spacing.xxl },
  attesa: { color: colors.testoSoft, fontSize: 13 },
  errore: { color: colors.errore, fontSize: 13, fontWeight: '700', textAlign: 'center' },
  lista: { padding: spacing.lg, gap: spacing.sm, paddingBottom: spacing.xxxl },
  card: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.sm,
