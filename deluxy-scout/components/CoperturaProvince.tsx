...
const styles = StyleSheet.create({
  ...
  tabella: { backgroundColor: colors.bianco, borderRadius: radius.l, borderWidth: 1, borderColor: colors.grigioChiaro, overflow: 'hidden' },
  riga: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  rigaBuco: { backgroundColor: colors.goldSoft },
  intestazione: { backgroundColor: colors.sfondo, paddingVertical: 8 },
  thTxt: { color: colors.testoSoft, fontSize: 11, fontWeight: '700', letterSpacing: 0.4, textTransform: 'uppercase' },
  ...
  euro: { color: colors.testo, fontWeight: '700', fontSize: 13.5 },
