...
const styles = StyleSheet.create({
  ...
  filtri: { paddingHorizontal: spacing.lg, paddingBottom: spacing.sm, gap: 6 },
  ...
  wideRow: { flexDirection: 'row', gap: spacing.xxl, alignItems: 'flex-start', maxWidth: 1180, alignSelf: 'center', width: '100%' },
  calPane: { flex: 1 },
  dayPane: { width: 340, gap: spacing.xs },
  dayStack: { marginTop: spacing.lg },
  ...
  navBtn: { padding: 6, borderRadius: radius.s, backgroundColor: colors.fill },
  ...
  cellaBox: { flex: 1, borderRadius: radius.s, alignItems: 'center', justifyContent: 'center', gap: 2 },
