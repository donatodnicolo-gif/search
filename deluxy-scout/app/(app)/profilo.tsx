...
const styles = StyleSheet.create({
  ...
  email: { fontSize: 18, fontWeight: '700', color: colors.navy },
  ...
  rowValue: { color: colors.navy, fontSize: 18, fontWeight: '600' },
  freccia: { color: colors.testoSoft, fontSize: 20, fontWeight: '600' },
  ...
  btnOff: { opacity: 0.5 },
  btnTxt: { color: colors.bianco, fontWeight: '700' },
