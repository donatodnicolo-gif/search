...
const styles = StyleSheet.create({
  ...
  nome: { fontSize: 24, fontWeight: '600', color: colors.navy, marginTop: spacing.sm, letterSpacing: -0.5 },
  ...
  btnSalvaLineeTxt: { color: colors.bianco, fontWeight: '700', fontSize: 14 },
  ...
  aiMatch: { color: colors.navy, fontWeight: '700', fontSize: 14 },
  btnRimuovi: {
    borderWidth: 1,
    borderColor: colors.grigioChiaro,
    borderRadius: radius.pill,
  ...
  contattoNome: { fontWeight: '700', color: colors.navy },
  ...
  dupTitolo: { color: colors.attenzione, fontWeight: '700', fontSize: 13, letterSpacing: 0.3 },
  ...
  dupNome: { color: colors.navy, fontWeight: '700', fontSize: 14 },
  ...
  btnUnisciTxt: { color: colors.bianco, fontWeight: '700', fontSize: 13 },
  ...
  dealLinea: { fontWeight: '700', color: colors.navy },
