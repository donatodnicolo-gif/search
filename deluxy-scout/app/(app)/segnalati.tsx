  ...
  return (
    ...
    >
      <View style={styles.headerScroll}>
        <PageIntro testo="I fioristi e le pasticcerie che l'app fornitori ha già trovato e messo nel registro. Non sono ancora tuoi: «Prendi in carico» li porta fra i Selezionati e da lì si lavorano come gli altri." />
      </View>
