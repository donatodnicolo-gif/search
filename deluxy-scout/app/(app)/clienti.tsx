...
const styles = StyleSheet.create({
  ...
  card: {
    gap: spacing.sm,
    backgroundColor: colors.bianco, borderRadius: radius.l, borderWidth: 1, borderColor: colors.grigioChiaro, padding: spacing.lg,
  },
  ...
  iconaBox: { width: 40, height: 40, borderRadius: radius.s, backgroundColor: colors.fill, alignItems: 'center', justifyContent: 'center' },
