  ...
  return (
    ...
    >
      <View style={styles.headerScroll}>
        <PageIntro testo="Tutte le province italiane, comprese quelle dove non abbiamo ancora niente: sono il motivo per cui questa schermata esiste. Ordinate per quanto ci si vende — dove il venduto è alto e i fornitori sono zero, c'è un buco da colmare." />
      </View>
        ...
        {viste.map((r) => {
          ...
          return (
            <Pressable
              ...
              onPress={() => router.push(`/(app)/affiliazioni?zona=${encodeURIComponent(r.nome)}`)}
            >
