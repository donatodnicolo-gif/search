...
const styles = StyleSheet.create({
  ...
  barra: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm, padding: spacing.lg, borderTopWidth: 1, borderTopColor: colors.grigioChiaro, backgroundColor: colors.bianco },
  ...
  revisione: { padding: spacing.lg, gap: 6 },
