...
const styles = StyleSheet.create({
  ...
  filtriTitolo: { fontSize: 12, fontWeight: '700', color: colors.testoSoft, letterSpacing: 0.5, textTransform: 'uppercase' },
  azzera: { color: colors.navy, fontWeight: '600', fontSize: 12 },
  filtroRiga: { gap: 4 },
  ...
  barFill: { height: 10, backgroundColor: colors.navy },
  ...
  dealLinea: { flex: 1, fontWeight: '700', color: colors.navy },
  ...
  btnNurtTxt: { color: colors.bianco, fontWeight: '700', fontSize: 13 },
  logout: { marginTop: spacing.xxxl, alignItems: 'center', paddingVertical: spacing.lg },
  logoutTxt: { color: colors.errore, fontWeight: '700' },
});
