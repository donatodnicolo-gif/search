...
const styles = StyleSheet.create({
  ...
  capAggiorna: { color: colors.navy, fontSize: 13, fontWeight: '600' },
  ...
  iconaNum: { color: colors.bianco, fontWeight: '700', fontSize: 18 },
  ...
  novita: { backgroundColor: colors.fill, borderRadius: radius.pill, paddingHorizontal: 8, paddingVertical: 2 },
  novitaTxt: { color: colors.testoSoft, fontWeight: '600', fontSize: 9, letterSpacing: 0.5 },
  ...
  crmRegistro: { backgroundColor: colors.fill },
  crmRegistroTxt: { color: colors.testoSoft, fontWeight: '600', fontSize: 10 },
