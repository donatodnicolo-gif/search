            ...
            {giro.map((p, i) => (
              ...
              >
                ...
                <View style={styles.tappaInfo}>
                  <Text numberOfLines={3} style={styles.tappaNome}>
                    {p.nome}
                  </Text>
...
const styles = StyleSheet.create({
  ...
  legenda: { color: colors.grigio, fontSize: 11, paddingHorizontal: spacing.lg, paddingBottom: 6 },
  map: { flex: 1 },
  mapPlaceholder: {
    flex: 1,
    alignItems: 'center',
  ...
  btnChiudi: { backgroundColor: colors.fill, borderRadius: radius.pill, paddingHorizontal: spacing.lg, paddingVertical: 10 },
