...
const styles = StyleSheet.create({
  ...
  stepWrapTab: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, paddingHorizontal: spacing.lg, paddingBottom: 10 },
  registroTab: { paddingHorizontal: spacing.lg, paddingBottom: 10 },
  ...
  sub: { color: colors.testoSoft, fontSize: 12, paddingHorizontal: spacing.lg, marginBottom: spacing.sm },
  search: {
  ...
  filtri: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, gap: 6 },
  chip: {
    backgroundColor: colors.bianco,
    borderWidth: 1,
    borderColor: colors.grigioChiaro,
