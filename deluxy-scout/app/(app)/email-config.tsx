...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: colors.ink, borderRadius: radius.pill, paddingVertical: 13, alignItems: 'center', marginTop: spacing.lg },
  btnOff: { opacity: 0.55 },
  btnTxt: { color: colors.bianco, fontWeight: '700', fontSize: 15 },
  rimuovi: { alignItems: 'center', paddingVertical: spacing.lg, marginTop: 4 },
