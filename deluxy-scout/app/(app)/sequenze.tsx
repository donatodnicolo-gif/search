...
const styles = StyleSheet.create({
  ...
  titoloSez: { color: colors.testoSoft, fontSize: 11, fontWeight: '700', letterSpacing: 0.5, textTransform: 'uppercase', marginTop: spacing.lg },
  ...
  cardTardi: { borderColor: colors.attenzione, backgroundColor: colors.goldSoft },
  ...
  tardi: { color: colors.goldStrong, fontWeight: '700', fontSize: 11.5 },
  ...
  passoOrdine: { width: 22, height: 22, borderRadius: 11, backgroundColor: colors.ink, color: colors.bianco, textAlign: 'center', lineHeight: 22, fontSize: 11, fontWeight: '700', overflow: 'hidden' },
