...
| `deluxy-scripts` | archivio degli script: variabili `{{COSÌ}}`, abilitazione per singola app, API di lettura | 3170 | — (non ancora pubblicata) | [docs/HANDOFF.md](deluxy-scripts/docs/HANDOFF.md) + [README.md](deluxy-scripts/README.md) |
...
merchandising, marketing, messaging, orders, scripts):
