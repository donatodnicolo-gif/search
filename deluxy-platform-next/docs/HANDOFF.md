...
> 📌 **STATO AL 11/09/2026 (sera) — per chi riprende.** Tutto pushato e LIVE: piattaforma `delivery-j2awpe275`, Merchandising `icufl4arz`, Finance `deluxy-partner-i8z44lxve`, Anagrafiche col capogruppo diretto; manuale **136**. Regole del deploy: dalla RADICE del worktree, dopo `nest build` + avvio locale di Nest; Merchandising e Finance dalle loro cartelle, build in cloud.
>
