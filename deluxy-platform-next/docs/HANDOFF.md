...
> - **7 vendite di agosto `payable=false` senza regola**: tutte importate dal legacy con quel flag (`legacy_update` nel registro), tutte di Sami, tutte senza riga di stipendio; #62748 è annullata. Dettaglio in chat del 10/09. Nessuna scrittura.
