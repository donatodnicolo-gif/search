...
> 📌 **STATO AL 11/09/2026 (notte) — per chi riprende.** Tutto pushato e LIVE: piattaforma `delivery-k8gfu6fpc`, Merchandising `icufl4arz`, Finance `deluxy-partner-i8z44lxve`, Anagrafiche col capogruppo diretto; manuale **150**. Regole del deploy: dalla RADICE del worktree, dopo `nest build` + avvio locale di Nest; Merchandising e Finance dalle loro cartelle, build in cloud.
>
