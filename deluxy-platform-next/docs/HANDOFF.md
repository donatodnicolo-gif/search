...
>
> 🔘 **11/09/2026 (mattina, 21) — «DISATTIVA / RIATTIVA» IN TABELLA PARTNER** (manuale 123). Web `partners-list`: `cambiaAttivazione(p)` + `attivazioneInCorso`, i18n `partners.reactivate`, `partners.deactivateConferma`.
