...
> - **Verificato in locale**: `prisma generate` + `tsc --noEmit` API verde; `ng build --configuration development` verde (solo il warning NG8107 pre-esistente in `receipts-list`); API dev su 3000 e web su **4220** (4200/4210 erano occupate da server di altre sessioni).
