...
> - 🔴 **Aperto**: l'arrotondamento a 5 NON è ancora applicato al `partnerPrice` delle riconciliazioni né al prezzo di riga della consegna (21 riconciliazioni su 107 hanno un prezzo non tondo). Da decidere con l'utente: sono numeri che finiscono in fattura e in paga.
