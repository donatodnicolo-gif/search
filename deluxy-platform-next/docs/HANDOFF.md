...
> ✅ **10/09/2026 (sera, 15) — APPENA ACCETTATE** (manuale 117). Web: `appenaAccettate` signal + `mostraAppenaAccettata(id)` (GET /deliveries/:id dopo `POST /sales/:id/accetta`), sezione `.appena-accettate` sopra la tabella, i18n `deliveries.proposte.appena*`. `ng build` ok.
