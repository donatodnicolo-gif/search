...
> 💶 **10/09/2026 (notte, 13) — MARGINI DELLA VENDITA NEL DETTAGLIO CONSEGNA** (manuale 115). In locale, `tsc` verdi API/web, avvio Nest ok; NON pubblicato (in attesa dell'ok).
