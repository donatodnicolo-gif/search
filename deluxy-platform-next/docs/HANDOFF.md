...
> 📌 **STATO AL 11/09/2026 (mattina) — per chi riprende.** Tutto pushato e LIVE: piattaforma `delivery-63sul1gr8`, Merchandising `icufl4arz`, Anagrafiche col capogruppo diretto; manuale 120. Aperti SOLO i punti che aspettano l'utente: «vai» per `applica-indice-sale-deliveryid.mjs` (poi 12895 → #101104); le 115 consegne chiuse di giugno-luglio; «allinea note» in Impostazioni; ripubblicare gli artifact dei manuali; i capogruppi Chanel e Diptyque/Olfattorio dal modulo partner. Regole del deploy: dalla RADICE del worktree, dopo `nest build` + avvio locale; Merchandising dalla sua cartella in cloud.
>
