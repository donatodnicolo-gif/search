...
> 📌 **STATO AL 11/09/2026 (notte tarda) — per chi riprende.** Tutto pushato e LIVE: piattaforma `delivery-hck8ii2ic`, Merchandising `icufl4arz`, Finance `deluxy-partner-i8z44lxve`, Anagrafiche col capogruppo diretto; manuale **159**. Regole del deploy: dalla RADICE del worktree, dopo `nest build` + avvio locale di Nest; Merchandising e Finance dalle loro cartelle, build in cloud.
>
