...
>
> 🗺️ **11/09/2026 (mattina, 24) — ELENCO PARTNER CON LE AREE** (manuale 126). Web `partners-list`: `primeAree/altreAree/restoAree`, colonna `partners.col.aree`, ripiego province; chiave di ricerca `aree.area.nome`.
