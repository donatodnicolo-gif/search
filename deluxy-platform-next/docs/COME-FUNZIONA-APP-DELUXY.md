...
Solo **Admin e Operation** (terzo tab in Prodotti). Regola dell'utente: «se un prodotto in una vendita non è unico, o è non-unico ma per quella provincia non ha una riconciliazione, mostra prodotto, provincia, partner e prezzo dato, con Accetta e Rifiuta: se accetta le prossime vendite vanno in automatico, se rifiuta non sarà mai più proposta; e un Modifica».
