...
>
> **Changelog**
> - 17/07/2026 (4) — Fusione del branch `platform-delivery-slots` in `deluxy-scout`: le due implementazioni delle **fasce di consegna dal setup del servizio** (fatte in parallelo) sono state riconciliate tenendo questa versione; in più il **seed** ora applica il setup prenotazione demo (fasce 2h 08–20, flessibile consentito su "Consegna prezzo fisso") anche ai DB già popolati.
...
>>>>>>> origin/platform-delivery-slots
