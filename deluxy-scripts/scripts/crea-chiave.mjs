// Crea (o rigenera) una chiave API per un'app client di Deluxy Scripts.
// Uso:  npm run chiave -- <nome-app> [--scrittura]
// Esempi:
//   npm run chiave -- deluxy-marketing              (sola lettura)
//   npm run chiave -- deluxy-orders --scrittura     (riservata a usi futuri)
//
// La chiave viene stampata UNA SOLA VOLTA: nel database resta solo lo SHA-256.
// Copiarla nel .env dell'app client come SCRIPTS_API_KEY.
