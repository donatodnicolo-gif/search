...
// Due compiti:
// 1. /api/v1/* — CORS: permette alle app Deluxy di leggere i propri script
//    anche dal browser. Le chiamate restano protette dalla chiave x-api-key.
// 2. tutto il resto (UI) — protezione con password unica come le altre app: se
//    SCRIPTS_APP_PASSWORD non è impostata (sviluppo locale) la UI è aperta.
const CORS_HEADERS = {
