// Client della cassaforte del Hub: le chiavi (OpenAI, …) si chiedono al
...
//
// Fonte di verità: la pagina /chiavi del Hub (progetto "deluxy-marketing").

const PROGETTO = "deluxy-marketing";
