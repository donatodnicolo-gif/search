...
// non uno per voce: due voci con due poll sarebbero due volte lo stesso
// lavoro.
//
...
const CHIAVE_VISTO = "marketing-sezioni-viste";
...
async function guarda(): Promise<void> {
  try {
    ...
    // ⚠️ Sessione scaduta: il middleware non risponde 401 ma un redirect
    // verso /login, che `fetch` segue da solo tornando la pagina di login con
    // stato 200. Si guardano tutte e tre le spie.
