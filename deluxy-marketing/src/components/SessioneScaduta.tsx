...
// Libro UX&UI v1.4 §7 (sistema del Customer Service): il poller dei pallini (PalliniNav)
...
/** Il nome dell'evento: lo mandano i poller (PalliniNav e Novita) quando se ne accorgono. */
