...
import { attivaRegolaApp, eliminaRegolaApp } from '@/lib/actions'

export function AzioniRegolaApp({ id, attiva }: { id: string; attiva: boolean }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
      ...
      <button
        ...
        disabled={inCorso}
        onClick={() => esegui(() => attivaRegolaApp(id, !attiva))}
      >
      ...
      {conferma ? (
        <>
          ...
          <button
            ...
            disabled={inCorso}
            onClick={() => esegui(() => eliminaRegolaApp(id))}
          >
            Confermi?
          </button>
        </>
