...
// (deluxy-platform-next) per il collettore unico — compensi valet e rimborsi.
...
await prisma.chiaveApi.create({
  data: {
    ...
    tettoRichiesta: 1000000,
    tettoGiornaliero: 5000000,
    urlNotifica: "https://deluxy-delivery.vercel.app/api/v1/transactions/esito",
  },
});
