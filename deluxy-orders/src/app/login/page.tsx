  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 24, fontWeight: 600, letterSpacing: "-0.022em" }}>Deluxy Orders</h1>
        <p style={{ fontSize: 14, color: "var(--text-secondary)", margin: "6px 0 22px" }}>Registro centralizzato ordini</p>
