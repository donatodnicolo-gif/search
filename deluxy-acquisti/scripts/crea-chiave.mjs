// Crea (o rigenera) una chiave API per un'app client di Deluxy Acquisti.
// Uso:  npm run chiave -- <nome-app> [--scrittura]
// Esempio: npm run chiave -- deluxy-platform --scrittura
//
// La chiave viene stampata UNA SOLA VOLTA: nel database resta solo lo SHA-256.
// Copiarla nel .env dell'app client (es. ACQUISTI_API_KEY=...).
...
const chiave = `dlac_${randomBytes(24).toString("hex")}`;
